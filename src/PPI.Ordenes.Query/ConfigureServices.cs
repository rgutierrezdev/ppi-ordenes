...
using PPI.Ordenes.Query.Data.Mappings;
using PPI.Ordenes.Query.Data.Repositories;
using PPI.Ordenes.Query.Data.Repositories.Abstractions;

namespace PPI.Ordenes.Query;
...
public static class ConfigureServices
{
    ...
    private static void ConfigureMongoDb()
    {
        try
        {
            ...
            new AssetMap().Configure(); // Configuration for Asset class
        }
        catch
        {
            // Ignore
