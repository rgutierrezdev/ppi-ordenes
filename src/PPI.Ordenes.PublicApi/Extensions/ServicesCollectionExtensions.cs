...
using PPI.Ordenes.Infrastructure;
...
internal static class ServicesCollectionExtensions
{
    ...
    private const string DbMigrationAssemblyName = "PPI.Ordenes.PublicApi";
    ...
    public static void AddHealthChecks(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var healthCheckBuilder = services
            .AddHealthChecks()
            .AddDbContextCheck<SqlDbContext>(tags: DbRelationalTags)
    ...
    {
        services.AddDbContext<SqlDbContext>((serviceProvider, optionsBuilder) =>
            ConfigureDbContext<SqlDbContext>(serviceProvider, optionsBuilder, QueryTrackingBehavior.TrackAll));
