...
namespace PPI.Ordenes.UnitTests.Fixtures;
...
public class EfSqliteFixture : IAsyncLifetime, IDisposable
{
    ...
    public EfSqliteFixture()
    {
        ...
        var builder = new DbContextOptionsBuilder<SqlDbContext>().UseSqlite(_connection);
        Context = new SqlDbContext(builder.Options);
    }
